...
export type reservedKeys = symbol | 'state' | 'rootState' | 'context' | 'module' | 'usedIn';
...
export type InferChildModuleProxies<T extends ModulePart> = {
  [P in keyof InferChildren<T>]: VuexTsModuleBuilderProxy<InstanceType<ReturnType<InferChildren<T>[P]>>> &
...
export type GetChildModuleProxies<T extends VuexTsModule> = {
  [P in keyof UnwrapModulePartFactory<T['modules']>]: VuexTsModuleBuilderProxy<
